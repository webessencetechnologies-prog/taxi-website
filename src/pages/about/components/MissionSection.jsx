      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            We're on a mission to eliminate the uncertainty and impersonal nature of ride-booking by creating direct relationships between passengers and drivers. Shivru Cabs is the artisanal approach to taxi services—where every ride matters.
          </p>
        </div>
