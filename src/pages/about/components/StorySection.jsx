      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground leading-relaxed">
            From a small fleet with big dreams to a trusted name in urban transportation, Shivru Cabs has always prioritized people over profits and relationships over transactions.
          </p>
        </div>
